//
// Created by excu on 1/7/23.
//

#ifndef VORTEX_FILE_MANAGER_JNI_CLASS_NAMES_H
#define VORTEX_FILE_MANAGER_JNI_CLASS_NAMES_H

#define STATUS_STRUCTURE "io/github/excu101/filesystem/unix/structure/UnixStatusStructure"
