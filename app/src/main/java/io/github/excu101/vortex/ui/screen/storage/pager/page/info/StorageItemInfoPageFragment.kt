...
import io.github.excu101.vortex.ui.component.ItemViewTypes.infoItem
...
class StorageItemInfoPageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        list = ItemRecyclerView(requireContext()).apply {
            ...
            adapter.add(infoItem, InfoItem as ViewHolderFactory<Item<*>>)
        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        requireArguments().parcelable<PathItem>(Args.Storage.ItemInfoPage.ItemInfoPageKey)?.let { item ->
